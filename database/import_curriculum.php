...
foreach ($items as $item) {
    $source->bind_param('ssssss',$item['subject'],$item['language'],$item['title'],$item['url'],$item['file'],$item['sha256']);
...
echo json_encode(['sources'=>$sources,'chunks'=>$chunks]);
