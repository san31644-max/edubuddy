...
if(file_put_contents($target,"<?php\nreturn ".var_export($values,true).";\n")===false)throw new RuntimeException('Could not write database secret.');
$webGroup='www-data';
if(function_exists('posix_getgrnam')&&posix_getgrnam($webGroup)!==false)chgrp($target,$webGroup);
chmod($target,0640);echo "Production database connection configured.\n";
