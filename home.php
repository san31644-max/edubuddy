...
@media(max-width:390px){.scroll-content{left:20%;right:20%}.scroll-logo{top:12px;width:125px;height:125px}.scroll-content h1{font-size:1.45rem}.scroll-link{min-height:34px;padding:5px;font-size:.65rem}}
