...
@media(max-width:390px){.scroll-content{left:20%;right:20%}.scroll-logo{width:50px;height:50px}.scroll-content h1{font-size:1.45rem}.scroll-link{min-height:34px;padding:5px;font-size:.65rem}}
